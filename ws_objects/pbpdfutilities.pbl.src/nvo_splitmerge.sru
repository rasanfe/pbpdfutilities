...
PUBLIC:
String is_assemblypath =  gs_dir+"SplitMergePdf.dll"
...
public function long of_splitfiles(string as_inputpath,string as_outputpath)
end prototypes
...
Try
	...
	/* Trigger the dotnet function */
	ll_result = This.splitfiles(as_inputpath,as_outputpath)
	Return ll_result
Catch(runtimeerror re_error)
