forward
global type nvo_splitmerge from dotnetobject
end type
end forward
...
global nvo_splitmerge nvo_splitmerge

type variables

PUBLIC:
String is_assemblypath = "DotNet\SplitMergePdf\SplitMergePdf.dll"
String is_classname = "SplitMergePdf.SplitMerge"
...
public function boolean of_mergefiles(string as_filenames[],string as_targetpdf)
public function long of_splitfiles(string as_inputfile,string as_outputpath)
public function string get_errortext()
public subroutine  set_errortext(string as_value)
end prototypes
...
Try
	...
	lbln_result = This.mergefiles(as_filenames,as_targetpdf)
	Return lbln_result
...
Try
	...
	/* Trigger the dotnet function */
	ll_result = This.splitfiles(as_inputfile,as_outputpath)
	Return ll_result
Catch(runtimeerror re_error)
...
on nvo_splitmerge.create
call super::create
TriggerEvent( this, "constructor" )
end on

on nvo_splitmerge.destroy
TriggerEvent( this, "destructor" )
call super::destroy
end on

event constructor;is_assemblypath = gs_dir + "DotNet\SplitMergePdf\SplitMergePdf.dll"
end event
